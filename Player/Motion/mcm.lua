...
local get_footX = function()
  return get_walk_footXComp() + footX
end

local get_kickX = function()
  return get_walk_kickXComp()
end

local get_headPitchBias = function()
  return get_walk_headPitchBiasComp() + headPitchBias
end

mcm.get_odometry = get_odometry
mcm.get_footX = get_footX
mcm.get_kickX = get_kickX
mcm.get_headPitchBias = get_headPitchBias
