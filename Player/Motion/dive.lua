...
--Role to back
    ...
    if diveType == "diveLeft" then
      --print("do diveLeft PH3");
      Body.set_larm_command(qLArm2);
    else
      --print("do diveRight PH3");
  ...
  elseif phase==4 then
    if diveType == "diveLeft" then
      --print("do diveLeft PH4");
      Body.set_larm_command(qLArm0);
    else
      --print("do diveRight PH4");
      Body.set_rarm_command(qRArm0);
    end
