...
local enableVelocity_ = Config.vision.enable_velocity_detection or 0
...
local get_xy = function(t)
  local x = t.r * math.cos(t.a)
  local y = t.r * math.sin(t.a)
  return x, y
end

local get_ra = function(t)
  return t.r, t.a
end

local get_deviation = function(t)
  local dr = math.sqrt(t.rVar)
  local da = math.sqrt(t.aVar)
  return dr, da
end

local observation_ra = function(t, r, a, rErr, aErr)
  rErr = rErr or 1
  aErr = aErr or 1
  local rVar = rErr ^ 2
  local aVar = aErr ^ 2
...
local observation_xy = function(t, x, y, rErr, aErr)
  rErr = rErr or 1
  aErr = aErr or 1
...
local odometry = function(t, dx, dy, da, drErr, daErr)
