...
local get_sound_detection = function()
  return {
    count = get_sound_detCount(),
...
wcm.get_ball = get_ball
wcm.get_pose = get_pose
wcm.get_tGoal = get_tGoal
wcm.get_attack_bearing = get_attack_bearing
wcm.get_attack_angle = get_attack_angle
wcm.get_defend_angle = get_defend_angle
wcm.get_sound_detection = get_sound_detection
